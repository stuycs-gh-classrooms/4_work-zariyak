//keyPressed ' ' is not working for some reason? but 'r' works
...
color DIRT_COLOR = color(129, 118, 111);
color FIRE_COLOR = color(240, 192, 177);
color BURNT_COLOR = color(192, 154, 142);
color GRASS_COLOR = color(194, 209, 173);
